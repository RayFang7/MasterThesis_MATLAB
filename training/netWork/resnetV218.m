function lgraph = resnetV218(numClasses,classesWeights)
lgraph = layerGraph();
tempLayers = [
...
tempLayers = [
    ...
    reluLayer("Name","res2a_branch2a_relu_2")
    ...
    reluLayer("Name","res2a_branch2a_relu_1")
...
tempLayers = [
    ...
    reluLayer("Name","res2b_branch2a_relu_2")
    ...
    reluLayer("Name","res2b_branch2a_relu_1")
...
tempLayers = [
    ...
    weightedClassificationLayer(classesWeights,"Weightedclassoutput")];
lgraph = addLayers(lgraph,tempLayers);

% 清理辅助变量
clear tempLayers;
lgraph = connectLayers(lgraph,"pool1","bn2a_branch2a");
lgraph = connectLayers(lgraph,"pool1","res2a/in2");
lgraph = connectLayers(lgraph,"res2a_branch2b","res2a/in1");
lgraph = connectLayers(lgraph,"res2a_relu","bn2b_branch2a");
lgraph = connectLayers(lgraph,"res2a_relu","res2b/in2");
lgraph = connectLayers(lgraph,"res2b_branch2b","res2b/in1");
