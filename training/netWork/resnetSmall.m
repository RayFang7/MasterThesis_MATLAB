%20201113 moved last layer to create function
function lgraph = resnetSmall()
lgraph = layerGraph();
tempLayers = [
...
tempLayers = depthConcatenationLayer(2,"Name","output");
lgraph = addLayers(lgraph,tempLayers);
...
lgraph = connectLayers(lgraph,"relu","gmpool");
lgraph = connectLayers(lgraph,"gapool","output/in2");
lgraph = connectLayers(lgraph,"gmpool","output/in1");
