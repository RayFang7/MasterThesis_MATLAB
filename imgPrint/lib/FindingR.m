function Rloc = FindingR(input)
Rloc = [];
for i = 1:size(input,2)
    try
        ecgdata = input(:,i);
        points= length(ecgdata);
        level=4;
...
plot (Mj4);axis tight;
        ...
        while i<points
            if interva2(i)==-1
                ...
                [Rtestx,Rtesty]=max(ecgdata(max(1,mark3-40):mark3));
        ...
        Mj4posi=Mj4.*(Mj4>0);
        %求正极大值的平均
        Mj4thposi=(max(Mj4posi(1:round(points/4)))+max(Mj4posi(round(points/4):2*round(points/4)))+max(Mj4posi(2*round(points/4):3*round(points/4)))+max(Mj4posi(3*round(points/4):points)))/4;
        Mj4posi=(Mj4posi>Mj4thposi/3);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        Mj4nega=Mj4.*(Mj4<0);
        %求负极大值的平均
        Mj4thnega=(min(Mj4nega(1:round(points/4)))+min(Mj4nega(round(points/4):2*round(points/4)))+min(Mj4nega(2*round(points/4):3*round(points/4)))+min(Mj4nega(3*round(points/4):points)))/4;
